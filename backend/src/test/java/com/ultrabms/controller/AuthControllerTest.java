...
class AuthControllerTest {
        ...
        void registerShouldReturn201WithValidRequest() throws Exception {
                ...
                verify(authService, times(1)).register(any(RegisterRequest.class), nullable(String.class),
        ...
        void loginShouldExtractIpFromForwardedHeader() throws Exception {
                ...
                // Assert - Should call login with HttpServletRequest (IP extraction happens in
                // AuthServiceImpl)
        ...
        void loginShouldExtractUserAgent() throws Exception {
                ...
                // Assert - Should call login with HttpServletRequest (User-Agent extraction
                // happens in AuthServiceImpl)
                verify(authService).login(any(), any(HttpServletRequest.class));
        }
        ...
        void refreshShouldReturn200WithValidTokenInBody() throws Exception {
                ...
                when(authService.refreshAccessToken(nullable(String.class), nullable(String.class),
                                nullable(String.class)))
                ...
                verify(authService).refreshAccessToken(eq("valid-refresh-token"), nullable(String.class),
                                nullable(String.class));
        }
        ...
        void refreshShouldReturn401WithNoToken() throws Exception {
                ...
                verify(authService, never()).refreshAccessToken(nullable(String.class), nullable(String.class),
                                nullable(String.class));
        }
        ...
        void authEndpointsShouldBePubliclyAccessible() throws Exception {
                ...
                when(authService.refreshAccessToken(nullable(String.class), nullable(String.class),
                                nullable(String.class))).thenReturn(tokenResponse);
