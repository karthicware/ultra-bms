...
- **React Hook Form + Zod:** Standard form validation pattern established in Story 2.5 [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md]
...
- **Authentication:** Protected routes using middleware from Story 2.5 [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md]
...
- ✅ **Axios API Client:** Use existing lib/api.ts with auto token refresh for all Epic 3 API calls [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#completion-notes]
- ✅ **Form Components:** Reuse PasswordInput, SubmitButton patterns for lead/quotation forms [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#new-files]
- ✅ **React Hook Form + Zod:** Standard validation pattern established - use for all forms [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#task-4]
- ✅ **shadcn/ui Components:** Form, Input, Select, Table, Dialog, Toast already installed and working [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#project-structure-notes]
- ✅ **AuthContext:** useAuth() hook available for checking authentication and user permissions [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#authcontext-pattern]
...
Follow same structure as types/auth.ts - define interfaces matching backend DTOs, export enums, use strict typing [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#task-3]
...
Use Zod schemas with inline errors, field-level validation, clear error messages, focus first error on submit [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#task-10]

**Error Handling Pattern:**
Use shadcn Toast for notifications (success=green, error=red), Alert for validation errors, inline messages below fields [Source: docs/sprint-artifacts/2-5-frontend-authentication-components-and-protected-routes.md#task-13]
...
- Story Context: `docs/sprint-artifacts/stories/3-1-lead-management-and-quotation-system.context.xml`
