...
- **Audit Logging Pattern Established:** Story 2.2 extends audit_logs table usage for authorization failures - reuse same pattern for password reset activities [Source: docs/sprint-artifacts/epic-2/2-2-role-based-access-control-rbac-implementation.md#ac10]
- **GlobalExceptionHandler Pattern:** Story 2.2 adds custom exception handlers - follow same pattern for InvalidTokenException and RateLimitExceededException [Source: docs/sprint-artifacts/epic-2/2-2-role-based-access-control-rbac-implementation.md#task-11]
- **Email Service Infrastructure:** Spring Mail is configured in Story 2.1's prerequisites - verify SMTP settings work before implementing [Source: docs/sprint-artifacts/epic-2/2-2-role-based-access-control-rbac-implementation.md#learnings-from-previous-story]
...
- **BCrypt Password Encoding:** PasswordEncoder bean already configured - reuse for hashing reset passwords [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#task-6]
- **User Entity Ready:** User entity with passwordHash field exists - update via PasswordResetService [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#project-structure-notes]
- **AuthController Exists:** Add password reset endpoints to existing AuthController [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#task-4]
- **Refresh Token Infrastructure:** RefreshToken entity and repository exist - delete user's refresh tokens on password reset for security [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#task-5]
- **UserRepository Available:** UserRepository.findByEmail() method exists - use to lookup user for password reset [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#files-to-reuse]
- **Audit Logging Setup:** AuditLog entity and pattern established - log all password reset activities [Source: docs/sprint-artifacts/epic-2/2-1-user-registration-and-login-with-jwt-authentication.md#task-7]
